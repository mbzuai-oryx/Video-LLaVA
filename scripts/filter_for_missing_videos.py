...
python scripts/filter_for_missing_videos.py \
    --input_json_file /share/users/shehan/data/ActivityNet/VideoInstruct100K/VideoInstruct_Dataset.json  \
    --output_json_file /share/users/shehan/data/ActivityNet/VideoInstruct100K/VideoInstruct_Dataset_Filtered_Missing.json \
    --clip_feature_path /share/users/shehan/drives/drive_2_shehan/CLIP_features_336
